...
import type { Language, Locale, TextDirection, Translations, UnlayerLocale, UnlayerTranslations } from './intl';
...
import type { CallbackTypeMap, Collection, CreditPurchaseRequest, CreditPurchaseResult, Device, DisplayMode, ExporterConfig, Location, Variant } from './types';
...
export type InboxPreviewClientId =
  | 'android10_gmailapp_pixel4_dm'
  | 'android10_gmailapp_pixel4_lm'
  | 'android11_gmailapp_pixel5_dm'
  | 'android12_gmailapp_pixel6_dm'
  | 'android12_gmailapp_pixel6_lm'
  | 'android12_outlookapp_pixel6_dm'
  | 'android12_outlookapp_pixel6_lm'
  | 'android13_gmailapp_pixel7_dm'
  | 'android13_gmailapp_pixel7_lm'
  | 'android14_gmailapp_pixel8_dm'
  | 'android14_gmailapp_pixel8_lm'
  | 'android15_gmailapp_pixel9_dm'
  | 'android15_gmailapp_pixel9_lm'
  | 'android16_gmailapp_pixel10_dm'
  | 'android16_gmailapp_pixel10_lm'
  | 'aolcom-dm_chrcurrent_win10'
  | 'aolcom-dm_edgecurrent_win10'
  | 'aolcom-dm_ffcurrent_win10'
  | 'aolcom-lm_chrcurrent_win10'
  | 'aolcom-lm_edgecurrent_win10'
  | 'aolcom-lm_ffcurrent_win10'
  | 'applemail16'
  | 'applemail16_dm'
  | 'freefr-dm_chrcurrent_win10'
  | 'freefr-dm_edgecurrent_win10'
  | 'freefr-dm_ffcurrent_win10'
  | 'freefr-lm_chrcurrent_win10'
  | 'freefr-lm_edgecurrent_win10'
  | 'freefr-lm_ffcurrent_win10'
  | 'gmailcom-dm_chrcurrent_win10'
  | 'gmailcom-dm_edgecurrent_win10'
  | 'gmailcom-dm_ffcurrent_win10'
  | 'gmailcom-lm_chrcurrent_win10'
  | 'gmailcom-lm_edgecurrent_win10'
  | 'gmailcom-lm_ffcurrent_win10'
  | 'gmxnet-lm_chrcurrent_win10'
  | 'gmxnet-lm_edgecurrent_win10'
  | 'gmxnet-lm_ffcurrent_win10'
  | 'iphone13ol_15'
  | 'iphone13ol_15_dm'
  | 'iphone14_16'
  | 'iphone14_16_dm'
  ...
  | 'iphone16pro_18_dm'
  | 'iphone16promax_18'
  | 'iphone16promax_18_dm'
  | 'iphone17_26'
  | 'iphone17_26_dm'
  | 'iphone17pro_26'
  | 'iphone17pro_26_dm'
  | 'iphone17promax_26'
  | 'iphone17promax_26_dm'
  | 'liberoit-lm_chrcurrent_win10'
  | 'liberoit-lm_edgecurrent_win10'
  | 'liberoit-lm_ffcurrent_win10'
  | 'm365_mac13_dm_dt'
  | 'm365_mac13_lm_dt'
  | 'm365_w11_dm_dt'
  | 'm365_w11_lm_dt'
  | 'm365com-dm_chrcurrent_win10'
  | 'm365com-dm_edgecurrent_win10'
  | 'm365com-dm_ffcurrent_win10'
  | 'm365com-lm_chrcurrent_win10'
  | 'm365com-lm_edgecurrent_win10'
  | 'm365com-lm_ffcurrent_win10'
  | 'o365_w10_dm_dt'
  | 'o365_w10_lm_dt'
  | 'outlook16_win10'
  | 'outlook16_win10_125'
  | 'outlook19'
  | 'outlook19_125'
  | 'outlook2021_win11_dm_dt'
  | 'outlook2021_win11_lm_dt'
  | 'outlook2024_win_dm_dt'
  | 'outlook2024_win_lm_dt'
  | 'outlookcom-dm_chrcurrent_win10'
  | 'outlookcom-dm_edgecurrent_win10'
  | 'outlookcom-dm_ffcurrent_win10'
  | 'outlookcom-lm_chrcurrent_win10'
  | 'outlookcom-lm_edgecurrent_win10'
  | 'outlookcom-lm_ffcurrent_win10'
  | 'tonlinede-lm_chrcurrent_win10'
  | 'tonlinede-lm_edgecurrent_win10'
  | 'tonlinede-lm_ffcurrent_win10'
  | 'webde-lm_chrcurrent_win10'
  | 'webde-lm_edgecurrent_win10'
  | 'webde-lm_ffcurrent_win10'
  | 'yahoocom-dm_chrcurrent_win10'
  | 'yahoocom-dm_edgecurrent_win10'
  | 'yahoocom-dm_ffcurrent_win10'
  | 'yahoocom-lm_chrcurrent_win10'
  | 'yahoocom-lm_edgecurrent_win10'
  | 'yahoocom-lm_ffcurrent_win10'
  | (string & {});
...
interface Config {
    ...
    /** Host-provided per-end-user display and client-side credit limits. */
...
declare class EditorClass<TClassDisplayMode extends DisplayMode | undefined = undefined> {
    ...
    /** Replace the host-provided credit position for one resource at runtime. */
    setCredits(resource: CreditResource, credits: CreditConfiguration): void;
...
export interface CreditConfiguration {
  /** Total allowance for the current end user. `null` means no host cap. */
  limit: number | null;
  /** Amount of the host allowance already consumed. */
  used: number;
  /** Blocks the resource independently of the numeric allowance. */
  disabled?: boolean;
  /** Percentage consumed at which the low-balance notice appears. */
  lowBalanceThresholdPercentage?: number;
  /** White-label display name, for example `credits` or `messages`. */
  unitLabel?: string;
  /** Absolute HTTP(S) fallback used when no purchase callback is registered. */
  purchaseUrl?: string;
}

export type CreditPurchaseHandler = (
  request: CreditPurchaseRequest,
) => CreditPurchaseResult | Promise<CreditPurchaseResult>;

export type CreditPurchaseReason =
  | 'low_balance'
  | 'exhausted'
  | 'disabled';

export type CreditResource = 'ai';

export type CreditsConfiguration = Partial<
  Record<CreditResource, CreditConfiguration>
>;
